...
gchar *
make_filename (gchar * sect,
               gchar * key,
               gchar * ext)
{
	return g_strdup_printf ("%s/.rotini/theme/%s.%s.%s", g_get_home_dir (),
	                        sect, key, ext);
}

void
cairo_set_source_alpha_color (cairo_t     * cr,
                              alpha_color * c)
{
...
void
load_shadow_color_setting (GKeyFile *f,
                           gint sc[3],
                           gchar    *key,
                           gchar    *sect)
{
...
void
load_string_setting (GKeyFile *f,
                     gchar    **s,
                     gchar    *key,
                     gchar    *sect)
{
