...
static void
layout_button_box(GtkWidget *vbox,
                  gint b_t)
{
	GtkWidget * filesel;
...
void
layout_general_buttons_frame (GtkWidget *hbox)
{
	GtkWidget * junk;
...
void
layout_button_pane (GtkWidget *vbox)
{
	GtkWidget * scroller;
	GtkWidget * hbox;
	gint i;
...
void
layout_window_frame (GtkWidget *vbox,
                     gboolean active)
{
	GtkWidget * scrollwin;
...
void
add_color_button_row (GtkWidget *vbox,
                      gchar     *title,
                      gchar     *key,
                      gchar     *sect)
{
...
void add_int_range_row (GtkWidget *vbox,
                        gchar     *title,
                        gchar     *key,
                        int start,
                        int end,
...
void
add_float_range_row (GtkWidget *vbox,
                     gchar     *title,
                     gchar     *key,
                     gdouble start,
                     gdouble end,
...
void
layout_shadows_frame (GtkWidget *vbox)
{
...
void
layout_title_frame (GtkWidget *vbox)
{
	GtkWidget * hbox;
	GtkWidget * junk;
...
void
add_meta_string_value (gchar *title,
                       gchar *key)
{
	GtkWidget * entry;
	table_append (gtk_label_new (title), FALSE);
...
void
layout_file_frame (GtkWidget *vbox)
{
	GtkWidget * junk;
	GtkWidget * hbox;
...
void
layout_info_frame (GtkWidget *vbox)
{
	table_new (2, FALSE, FALSE);
	gtk_box_pack_startC (vbox, get_current_table (), FALSE, FALSE, 0);
...
void
layout_borders_frame (GtkWidget *vbox)
{
	table_new (2, FALSE, FALSE);
	gtk_box_pack_startC (vbox, get_current_table (), FALSE, FALSE, 0);
...
void
layout_left_frame_pane (GtkWidget *hbox)
{
	GtkWidget * vbox;
...
void
layout_right_frame_pane (GtkWidget *hbox)
{
	GtkWidget * vbox;
	vbox = gtk_vbox_new (FALSE, 2);
	gtk_box_pack_startC (hbox, vbox, TRUE, TRUE, 0);
...
void
layout_frame_pane (GtkWidget *vbox)
{
	GtkWidget * hbox;
...
void
layout_left_global_pane (GtkWidget *hbox)
{
	GtkWidget * vbox;
	vbox = gtk_vbox_new (FALSE, 2);
	gtk_box_pack_startC (hbox, vbox, TRUE, TRUE, 0);
...
void
layout_right_global_pane(GtkWidget *hbox)
{
	GtkWidget * vbox;
	vbox = gtk_vbox_new (FALSE, 2);
	gtk_box_pack_startC (hbox, vbox, TRUE, TRUE, 0);
...
void
layout_global_pane (GtkWidget *vbox)
{
	GtkWidget * hbox;
...
void
layout_screenshot_frame (GtkWidget *vbox)
{
	GtkWidget * filesel;
	GtkFileFilter * imgfilter;
	GtkWidget * clearer;
...
void
layout_left_theme_pane (GtkWidget *hbox)
{
	GtkWidget * vbox;
	vbox = gtk_vbox_new (FALSE, 2);
	gtk_box_pack_startC (hbox, vbox, TRUE, TRUE, 0);
...
void
layout_right_theme_pane (GtkWidget *hbox)
{
	GtkWidget * vbox;
	vbox = gtk_vbox_new (FALSE, 2);
	gtk_box_pack_startC (hbox, vbox, TRUE, TRUE, 0);
...
void
layout_theme_pane (GtkWidget *vbox)
{
	GtkWidget * hbox;
	hbox = gtk_hbox_new (FALSE, 2);
	gtk_box_pack_startC (vbox, hbox, TRUE, TRUE, 0);
...
void
layout_settings_pane (GtkWidget *vbox)
{
	GtkWidget * combo;
	GtkWidget * junk;
	gint i;
...
void
layout_engine_pane (GtkWidget *vbox)
{
...
void
layout_lower_pane (GtkWidget *vbox)
{
	GtkWidget * notebook;
...
GtkWidget *
build_lower_pane (GtkWidget *vbox)
{
	GtkWidget * expander;
	GtkWidget * my_vbox;
...
void
import_cache(GtkWidget * progbar)
{
	GDir * d;
...
void
layout_upper_pane (GtkWidget * vbox)
{
	//GtkWidget * hbox;
...
void
layout_repo_pane (GtkWidget * vbox)
{
	GtkWidget * hbox;
	GtkWidget * rlabel;
	gtk_box_pack_startC (vbox, gtk_label_new (
...
void
layout_themes_pane (GtkWidget * vbox)
{
	GtkWidget * notebook;
	notebook = gtk_notebook_new ();
	gtk_box_pack_startC (vbox, notebook, TRUE, TRUE, 0);
...
GtkWidget*
create_filechooserdialog1 (char *input)
{
